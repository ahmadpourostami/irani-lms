...
final class CourseServiceProvider implements ServiceProviderInterface {
    ...
    public function meta(): CourseMeta { return $this->meta; }
    public function curriculum(): Curriculum { return $this->curriculum; }
    public function curriculum_manager(): CurriculumManager { return $this->curriculum_manager; }
}
